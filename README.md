...
- [ ] **カレンダー統合**: メモを日付ごとにカレンダー表示
- [ ] **エクスポート機能**: PDF/Markdown形式でメモをエクスポート
- [ ] **音声共有**: AirDropやメッセージでメモを共有

### 中期目標（3-6ヶ月）
- [ ] **リアルタイム文字起こし**: 録音中にライブで文字起こし表示
- [ ] **ウィジェット対応**: ホーム画面から即座に録音開始
- [ ] **Apple Watch対応**: 手首からワンタップ録音
...
- [ ] **コラボレーション**: チームメンバーとメモ共有
- [ ] **音声フィンガープリント**: 重複メモの自動検出
- [ ] **感情分析**: 音声のトーンから感情を分析してタグ付け
